...
},{"backbone":2,"kuzhanggui-formix":5,"kuzhanggui-modals":6,"multiline":8,"node-django-csrf-support":10,"underscore":12}],2:[function(require,module,exports){
//     Backbone.js 1.1.2
...
var Modal = Backbone.View.extend({
    initialize: function(options) {
        ...
        this.setElement($(Modal.tpl(options).trim()));
        ...
        this.setSaveText(options.save, options.loading);
...
var FormModal = Modal.extend({
    ...
    setForm: function(form) {
        ...
        this.$form.submit(_.bind(this.onSave, this));
        this.form.on('save', _.bind(function() {
            forgot(_.bind(function() {
...
var ActionModal = Modal.extend({
    initialize: function(options) {
        Modal.prototype.initialize.call(this, _.defaults(options || {}, {
            loading: 'Confirm',
            save: 'Confirm',
            size: 'small'
        }));
        ...
        this.$cancel.hide();
        this.$tip = $("<div class='tip alert alert-warning' style='margin-bottom: 0px; display: none'></div>").appendTo(this.$body);
        this.$save
    ...
    onConfirm: function() {
        ...
        this.action.call(null, this.data).ensure(_.bind(function() {
            this.$el.modal('unlock');
            this.$save.button('reset');
        }, this));
    }
...
},{"backbone":2,"forgot":4,"underscore":7}],7:[function(require,module,exports){
module.exports=require(3)
},{"/opt/kuzhanggui-contents/node_modules/backbone/node_modules/underscore/underscore.js":3}],8:[function(require,module,exports){
'use strict';
...
},{"cookies-js":11}],11:[function(require,module,exports){
/*!
 * Cookies.js - 0.4.0
 *
